...
where $\alpha_{ij}^{kc}$ are closed-form coefficients derived from second- and third-order partial derivatives. This formulation allows the model to capture the full spatial extent of the tumor, rather than just the most discriminative part.
